...
export default class Mixer {
  el: HTMLElement;
  channels: Array<InstanceType<typeof ChannelInterface>>;
  effects: Record<string, InstanceType<typeof EffectInterface>>;
  pilot: any;
  ...
  private initializeChannels(pilot: any): void {
  ...
  private initializeEffects(pilot: any): void {
