...
export default function Theme(this: any, _default: any): void {
  const themer = this;
  ...
  this.install = function (this: any, host: HTMLElement = document.body, callback?: () => void): void {
  ...
  this.load = function (this: any, data: any): void {
  ...
  this.reset = function (this: any): void {
    this.load(_default)
  };

  function parse (any: any): any {
  ...
  this.drag = function (this: any, e: DragEvent): void {
    e.stopPropagation()
    e.preventDefault()
    if (e.dataTransfer) {
  ...
  this.drop = function (this: any, e: DragEvent): void {
    e.preventDefault()
    e.stopPropagation()
  ...
  this.open = function (this: any): void {
    ipcRenderer.invoke('show-open-dialog', {
      ...
      if (!result.canceled && result.filePaths.length > 0) {
        const fs = require('fs');
        fs.readFile(result.filePaths[0], 'utf8', (err: NodeJS.ErrnoException | null, data: string) => {
          if (err) {
            console.error(err);
            return;
          }
  ...
  function validate (json: any): boolean {
